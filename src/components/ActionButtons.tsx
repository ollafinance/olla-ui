...
export function ActionButtons({ 
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        {mint.isPending ? "Minting..." : mint.isConfirming ? "Confirming..." : "1. Mint 100 AZT"}
      </button>

      {/* Approve Step */}
      <button
        onClick={approve.write}
        disabled={!isConnected || approve.isPending || approve.isConfirming || isApproved}
      ...
      >
        {approve.isPending ? "Approving..." : approve.isConfirming ? "Confirming..." : isApproved ? "Approved" : "2. Approve 0.1 AZT"}
      </button>

      {/* Deposit Step */}
      <button
        onClick={deposit.write}
        disabled={!isConnected || deposit.isPending || deposit.isConfirming || !isApproved}
      ...
      >
        {deposit.isPending ? "Depositing..." : deposit.isConfirming ? "Confirming..." : "3. Deposit 0.1 AZT"}
      </button>
    </div>
  );
}
